            ...
            <div style={{ display: 'grid', gap: '20px' }}>
              ...
              >
                ...
                <ol style={{ color: 'var(--muted)', paddingLeft: '20px', margin: 0 }}>
                  ...
                  <li>Webhook URL: https://commerce.magnetic-ict.com/api/shopify/webhooks/orders/create</li>
                </ol>
              </div>
        ...
        <div className="card" style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gap: '12px' }}>
            ...
            >
              ...
              https://commerce.magnetic-ict.com/api/shopify/webhooks/orders/create
            </div>
            <div
              style={{
                padding: '12px',
            ...
            >
              ...
              https://commerce.magnetic-ict.com/api/shopify/webhooks/orders/fulfilled
            </div>
            <div
              style={{
                padding: '12px',
            ...
            >
              ...
              https://commerce.magnetic-ict.com/api/shopify/webhooks/orders/cancelled
            </div>
          </div>
        </div>
      </div>
