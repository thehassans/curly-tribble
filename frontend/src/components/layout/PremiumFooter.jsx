        ...
        <div className="pf2-payments-inner">
          ...
          <div className="pf2-pay-badge">
            <span style={{display:'flex',alignItems:'center',gap:2}}>
              <span style={{fontSize:13,fontWeight:700,color:'#253B80',letterSpacing:'-0.02em'}}>Pay</span>
              <span style={{fontSize:13,fontWeight:700,color:'#179BD7',letterSpacing:'-0.02em'}}>Pal</span>
            </span>
          </div>
          {/* Visa */}
          <div className="pf2-pay-badge">
